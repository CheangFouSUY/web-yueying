    ...
    <div class="comment-wrap">
      ...
      <el-row class="comment-box" v-for="item in comments" :key="item.id">
        ...
        <el-row :gutter="70">
          ...
          <el-col :span="22">
            <el-row class="comment-publisher">{{ item.publisherName }}</el-row>
...
export default {
  ...
  mounted() {
    ...
    for (let i = 0; i < this.comments.length; i++) {
      ...
      // console.log(new Date(this.comments[i].createdAt).getTime());
    }
  },
  methods: {
    like() {
      ...
      // this.$axios({
      //   method: "put",
      //   url: "/api/v1/book/react/" + this.$route.params.id,
      //   data: {
      //     response: "L",
